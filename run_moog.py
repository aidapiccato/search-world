...
$ python3 run_moog.py --config=path.to.your.config
...
flags.DEFINE_integer('render_size_height',  700,
                     'Height and width of the output image.')
...
def main(_):
    ...
    config['observers']['image'] = observers.PILRenderer(
        image_size=(FLAGS.render_size_width, FLAGS.render_size_height),
    ...
    human_agent.HumanAgent(
        env,
        render_size=FLAGS.render_size_width,
        fps=FLAGS.fps,
